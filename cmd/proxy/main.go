...
import (
	...
	"github.com/sazonovItas/go-simple-proxy/pkg/logger/sl"
)

func main() {
	logger := sl.NewPrettyLogger(slog.LevelDebug, os.Stdout)
	...
	proxyHandler := proxy.NewProxyHandler(logger, cfg.Proxy.Secrets, cfg.Proxy.BlockList)
